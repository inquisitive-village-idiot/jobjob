...
def _build_prompt(
    ...
    return (
        ...
        f"- Write conversationally, as if explaining to a colleague why this role excites you\n"
        ...
        f"- Let the letter flow naturally; prioritize readability over hitting every point\n"
